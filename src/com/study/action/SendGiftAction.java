...
public class SendGiftAction extends IAction{
	...
	public void doAction(HttpServletRequest request, HttpServletResponse response) throws IOException, SQLException {
		...
		String userId = getParam(request, RequestParamKey_UserId, "");//获取请求参数——赠送者ID
		...
		try {
			...
			if(resultSet!=null&&resultSet.next()) {
				...
				String updateUserSql="UPDATE `userinfo` SET "
						+ "`user_level`="+dbLevel+",`send_nums`="+dbSendNum+",`exp`="+dbExp+
